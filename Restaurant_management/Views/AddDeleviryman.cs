    ...
    public partial class AddDeleviryman : Form
    {
        ...
        private void ButtonConfirm_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                DeliverymansController.AddDeliverymans(textBoxname.Text, textBoxUname.Text, textBoxPass.Text, textBoxEmail.Text, textBoxaddress.Text, textBoxPhone.Text, groupBoxGander.Text, dateTimePicker1.Value.ToString("dd-MM-yyyy"));
        ...
        private void GroupBoxGander_Enter(object sender, EventArgs e)
        {
